let conta = {
  ...
  let ana = new Conta(5486273622, "conta corrente", 277771, "ana couto");
  ...
  // banco.consultarCliente(ana);
  // banco.deposito(ana, 1);
  // banco.consultarCliente(ana);
  // banco.saque(aana, 1);
  // banco.consultarCliente(ana);
  
  // banco.deposito(ana, 1000000);
  // banco.consultarCliente(ana);
  // banco.saque(ana, 1000000);
  // banco.consultarCliente(ana);